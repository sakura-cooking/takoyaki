...
|  器具                            |  用意するもの                   |
| -------------------------------- | ------------------------------- |
|  **使い捨てテーブルクロス、新聞紙、ブルーシート**   | 焼き台の下には使い捨てのシートを引いておくのが**絶対よい**です。 生地入れの時、焼いているとき、気を付けていても こぼれたり跳ねたりします。大規模にやる場合は、焼き場周辺の床にもシートを引いておくことをおすすめします。|
|  **養生テープ**                  | |
|  **たこ焼きポスター**            |   焼き場にタコやきのチラシを張っておくと雰囲気が出るかも。 [たこ焼きチラシ](/etc/) |
...
|  器具                              |  用意するもの                   |
| ---------------------------------- | ------------------------------- |
|  **軽量カップ 500ml～１Ｌ**        | 大きい方が楽。|
|  **はかり、キッチンスケール**      | 必要なら、軽量スプーンも。|
|  **バケツ またはそれに準ずるもの** | 生地の水 x2～2.5くらいの容量が良い。水に材料を入れると 水6Lの場合は12Lくらいになります。攪拌する余白を考えて10～15L用がおススメ |
|  **泡だて器、電動ハンドミキサー**  | バケツの底に粉がたまるので、しっかり混ぜる。ハンドミキサーは持っていれば楽できます。|
|  **さいばし**  | |
...
| ------------------------ | ------------------------------- |
|  **クッキングペーパー**  | 大きい方が楽。|
|  **使い捨て手袋**        | 素手調理が気になる人場合は、手袋をして 下ごしらえする。タコを扱うときはあるととても楽です(手が臭くならない) |
...
|  器具               |  用意するもの                   |
| ------------------- | ------------------------------- |
|  **たこ焼き器**     | 【必須】大きい方が楽。最近おススメ!!**「CB-ETK-1 イワタニ たこ焼き専用器 [カセットガスたこ焼器 スーパー炎たこ（えんたこ）](http://www.i-cg.jp/product/grill/cb-etk-1/)」**。火力がかなり強く、一気に焼きあがるので **最高に使いやすい**。 焼き待ち時間が 驚くほど短くなります！|
|  **たこ焼きピック、竹串**  | 「キッチンペーパー＋さいばしぬりぬり」 でも代用可能。火災注意。油引きは相性が悪いととっても使いづらい。キッチングペーパーで油をひいてしまうのも◎。|
|  **油引き**         | 生地の水 x2～2.5くらいの容量が良い。水に材料を入れると 水6Lの場合は12Lくらいになります。攪拌する余白を考えて10～15L用がおススメ |
|  **キッチンペーパー**  | |
|  **さいばし**       | |
|  **ひしゃく、お玉** |ちょっと攪拌したり、生地をたこ焼き機に流し込むために使う。注ぎ込む口があると注ぎやすい。また柄が長いともっと良い。|
